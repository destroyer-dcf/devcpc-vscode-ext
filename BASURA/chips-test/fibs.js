...
exports.build = exports.configure = void 0;
const nestestlog_ts_1 = require("./fibs-scripts/nestestlog.ts");
const fuse_ts_1 = require("./fibs-scripts/fuse.ts");
const vic20_via_tests_ts_1 = require("./fibs-scripts/vic20-via-tests.ts");
const c64_wlspecial_tests_ts_1 = require("./fibs-scripts/c64-wlspecial-tests.ts");
const webpage_ts_1 = require("./fibs-scripts/webpage.ts");
function configure(c) {
    ...
    (0, vic20_via_tests_ts_1.addVic20TestCommand)(c);
    (0, c64_wlspecial_tests_ts_1.addC64TestCommand)(c);
    (0, nestestlog_ts_1.addNesTestLogJob)(c);
    (0, fuse_ts_1.addFuseJob)(c);
    (0, webpage_ts_1.addWebpageCommand)(c);
}
